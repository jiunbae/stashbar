...
let backgroundTop = color(0.965, 0.961, 0.945) // #F6F5F1
let backgroundBottom = color(0.925, 0.927, 0.918)
let graphite = color(0.169, 0.200, 0.227) // #2B333A
let steel = color(0.420, 0.561, 0.651) // #6B8FA6
let steelLight = color(0.535, 0.651, 0.718)
...
let filePath = rounded(fileRect, S * 0.030)
drawShadowed(
    filePath,
    fill: steel,
